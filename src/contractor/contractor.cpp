...
#pragma pack(pop, r1)
    ...
    BOOST_ASSERT(is_aligned<extractor::lookup::TurnPenaltiesHeader>(turn_weight_penalty_ptr));
    ...
    BOOST_ASSERT(is_aligned<extractor::lookup::TurnIndexBlock>(turn_index_block_ptr));
