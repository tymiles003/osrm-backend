...
void BasicRoutingInterface::RoutingStep(const std::shared_ptr<datafacade::BaseDataFacade> facade,
...
EdgeWeight
BasicRoutingInterface::GetLoopWeight(const std::shared_ptr<datafacade::BaseDataFacade> facade,
                                     NodeID node) const
{
 ...
 */
void BasicRoutingInterface::UnpackEdge(const std::shared_ptr<datafacade::BaseDataFacade> facade,
                                       const NodeID from,
                                       const NodeID to,
...
// requires
// a force loop, if the heaps have been initialized with positive offsets.
void BasicRoutingInterface::SearchWithCore(const std::shared_ptr<datafacade::BaseDataFacade> facade,
                                           SearchEngineData::QueryHeap &forward_heap,
                                           SearchEngineData::QueryHeap &reverse_heap,
...
double
BasicRoutingInterface::GetPathDistance(const std::shared_ptr<datafacade::BaseDataFacade> facade,
...
// the addition of force_loop parameters might be required
double
BasicRoutingInterface::GetNetworkDistance(const std::shared_ptr<datafacade::BaseDataFacade> facade,
                                          SearchEngineData::QueryHeap &forward_heap,
                                          SearchEngineData::QueryHeap &reverse_heap,
                                          const PhantomNode &source_phantom,
                                          const PhantomNode &target_phantom,
