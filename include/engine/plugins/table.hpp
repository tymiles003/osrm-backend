...
class TablePlugin final : public BasePlugin<AlgorithmT, FacadeT>
{
  ...
  private:
    ...
    mutable routing_algorithms::ManyToManyRouting<AlgorithmT, FacadeT> distance_table;
    const int max_locations_distance_table;
};

template <typename AlgorithmT, template <typename A> class FacadeT>
Status TablePlugin<AlgorithmT, FacadeT>::HandleRequest(
