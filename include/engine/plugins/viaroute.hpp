...
class ViaRoutePlugin final : public BasePlugin<AlgorithmT, FacadeT>
{
  private:
    ...
    mutable routing_algorithms::AlternativeRouting<AlgorithmT, FacadeT> alternative_path;
    mutable routing_algorithms::DirectShortestPathRouting<AlgorithmT, FacadeT> direct_shortest_path;
...
template <typename AlgorithmT, template <typename A> class FacadeT>
Status ViaRoutePlugin<AlgorithmT, FacadeT>::HandleRequest(
