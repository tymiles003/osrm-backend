...
Feature: Traffic - speeds
    ...
    Scenario: Weighting based on speed file weights, ETA based on file durations
        ...
        And I route I should get
          | from | to | route       | speed   | weights           |
          | a    | b  | ad,de,eb,eb | 30 km/h | 2.7,400.4,378.2,0 |
          | a    | c  | ad,dc,dc    | 31 km/h | 2.7,956.8,0       |
          | b    | c  | bc,bc       | 27 km/h | 2.7,0             |
          | a    | d  | ad,ad       | 27 km/h | 2.7,0             |
          | d    | c  | dc,dc       | 36 km/h | 956.8,0           |
          | g    | b  | ab,ab       | 1 km/h  | 1.4,0             |
          | a    | g  | ab,ab       | 1 km/h  | 1.3,0             |
    ...
    Scenario: Weighting based on speed file weights, ETA based on file durations
        ...
        And I route I should get
          | from | to | route       | speed   | weights           |
          | a    | b  | ad,de,eb,eb | 2 km/h  | 2.7,400.4,378.2,0 |
          | a    | c  | ad,dc,dc    | 2 km/h  | 2.7,956.8,0       |
          | b    | c  | bc,bc       | 27 km/h | 2.7,0             |
          | a    | d  | ad,ad       | 1 km/h  | 2.7,0             |
          | d    | c  | dc,dc       | 36 km/h | 956.8,0           |
          | g    | b  | ab,ab       | 1 km/h  | 1.4,0             |
          | a    | g  | ab,ab       | 1 km/h  | 1.3,0             |
